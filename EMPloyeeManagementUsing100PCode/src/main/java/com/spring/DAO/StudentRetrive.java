...
public class StudentRetrive implements IStudentRetrive {
	...
	public static final String QRY_TO_RETRIVE = "SELECT ID,NAME,ADDRESS,CITY,SALLARY,JOB,DEPARTMENT,depIDl FROM CIVIL";
	public static final String QRY_TO_EDIT = "SELECT ID,NAME,ADDRESS,CITY,SALLARY,JOB,DEPARTMENT,depIDl FROM CIVIL WHERE ID=?";
	public static final String QRY_TO_UPDATE = "UPDATE CIVIL SET CITY=?,ADDRESS=? WHERE ID=?";
	public static final String QRY_OF_DEPPid="SELECT depIDl FROM CIVIL";	
	@Autowired
...
public List<Integer> dept() {
	// TODO Auto-generated method stub
       return jov.query(QRY_OF_DEPPid,new MyDEP());
}

public class MyDEP implements ResultSetExtractor<ArrayList<Integer>>
{
